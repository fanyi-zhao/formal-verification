 ...
 /home/artifact/Synchronicity/workspace/Synchronicity/tests/parser2.sink:                           
...
procedure  Node.f(tid:Tid, this : Node)                                                             
...
{                                                                                                   
 var this2920332: Node;                                                                             
 var x: int;                                                                                        
 var x2920332: int;                                                                                 
 var Node.x2920332: [Node]int;                                                                      
 var $recorded.state2920332: int;                                                                   
 var z: int;                                                                                        
 var y: int;                                                                                        
 var Node._lock2920332: [Node]Tid;                                                                  
 var y2920332: int;                                                                                 
 var $pc2920332: Phase;                                                                             
 var tid2920332: Tid;                                                                               
 var Node._state2920332: [Node]State;                                                               
 var z2920332: int;                                                                                 
 ...
 assume Node._state2920332 == Node._state && Node.x2920332 == Node.x && Node._lock2920332 == Node._lock && x2920332 == x && z2920332 == z && y2920332 == y && this2920332 == this && tid2920332 == tid;
 assume $recorded.state2920332 == 1;                                                                
 return;                                                                                            
}                                                                                                   
...
//// Spec Checks                                                                                    
 ...
 assert isError(_writeByU_Mover);                                                                          // (3.5): Node.x failed Write-Write Right-Mover Check
 }                                                                                                  
 ...
 assert _readByU_Mover == _E;                                                                              // (3.5): Node.x failed Write-Read Right-Mover Check
 }                                                                                                  
 ...
 _writeByU_Mover := m#moverPath(_writeByU);                                                         
 _writeByU_Path := p#moverPath(_writeByU);                                                          
 assert isError(_writeByU_Mover);                                                                          // (3.5): Node.x failed Write-Write Left-Mover Check
 }                                                                                                  
 ...
 assert _readByU_Mover == _E;                                                                              // (3.5): Node.x failed Write-Read Left-Mover Check
 }                                                                                                  
 ...
 assert isError(_writeByU_Mover);                                                                          // (3.5): Node.x failed Read-Write Right-Mover Check
 }                                                                                                  
 ...
 assert isError(_writeByU_Mover);                                                                          // (3.5): Node.x failed Read-Write Left-Mover Check
 }                                                                                                  
 ...
 assert (leq(_writeByT_Mover, _R) && leq(_writeByUPost_Mover, _E)) ==> ((_writeByU_Mover == _writeByUPost_Mover || _writeByU_Mover == _E));       // (3.5): Node.x is not Write-Write Stable with respect to Node.x (case A.1)
 assert (leq(_writeByT_Mover, _N) && !leq(_writeByUPost_Mover, _L)) ==> (!leq(_writeByU_Mover, _L));       // (3.5): Node.x is not Write-Write Stable with respect to Node.x (case A.2)
 assert (x != y && leq(_writeByT_Mover, _N) && leq(_writeByUPost_Mover, _L)) ==> ((_writeByUPost_Mover == _writeByUPost_Mover || _writeByUPost_Mover == _E));       // (3.5): Node.x is not Write-Write Stable with respect to Node.x (case A.3)
 ...
 assert (leq(_writeByT_Mover, _E) && leq(_writeByU_Mover, _L)) ==> ((_writeByTPost_Mover == _writeByT_Mover || _writeByTPost_Mover == _E));       // (3.5): Node.x is not Write-Write Stable with respect to Node.x (case C)
 ...
 assert (leq(_writeByT_Mover, _R) && leq(_writeByUPost_Mover, _N)) ==> ((_writeByTPost_Mover == _writeByT_Mover || _writeByTPost_Mover == _E));       // (3.5): Node.x is not Write-Write Stable with respect to Node.x (case D)
 assert (leq(_writeByT_Mover, _N) && leq(_writeByUPost_Mover, _L)) ==> ((_writeByTPost_Mover == _writeByT_Mover || _writeByTPost_Mover == _E));       // (3.5): Node.x is not Write-Write Stable with respect to Node.x (case R)
 ...
 assert (leq(_readByT_Mover, _R) && leq(_writeByU_Mover, _N)) ==> ((_readByTPost_Mover == _readByT_Mover || _readByTPost_Mover == _E));       // (3.5): Node.x is not Read-Write Stable with respect to Node.x (case F)
 assert (leq(_readByT_Mover, _E) && leq(_writeByU_Mover, _L)) ==> ((_readByTPost_Mover == _readByT_Mover || _readByTPost_Mover == _E));       // (3.5): Node.x is not Read-Write Stable with respect to Node.x (case H)
 assert (x != y && leq(_readByT_Mover, _N) && leq(_writeByU_Mover, _N)) ==> ((_readByTPost_Mover == _readByT_Mover || _readByTPost_Mover == _E));       // (3.5): Node.x is not Read-Write Stable with respect to Node.x (case I)
 ...
 assert (leq(_writeByT_Mover, _R) && leq(_readByUPost_Mover, _E)) ==> ((_readByU_Mover == _readByUPost_Mover || _readByU_Mover == _E));       // (3.5): Node.x is not Write-Read Stable with respect to Node.x (case J)
 assert (leq(_writeByT_Mover, _N) && leq(_readByUPost_Mover, _L)) ==> ((_readByU_Mover == _readByUPost_Mover || _readByU_Mover == _E));       // (3.5): Node.x is not Write-Read Stable with respect to Node.x (case K)
 assert (leq(_writeByT_Mover, _N) && !leq(_readByUPost_Mover, _L)) ==> (!leq(_readByU_Mover, _L));         // (3.5): Node.x is not Write-Read Stable with respect to Node.x (case L)
...
// 378.1-429.2: (Method:4.5)
// 385.1-385.24: (4.5): Bad tid
// 386.1-386.38: (4.5): this is not global
// 410.2-412.2: (class anchor.sink.VarDeclStmt:5.7)
// 413.2-415.2: (class anchor.sink.VarDeclStmt:6.7)
// 416.2-418.2: (class anchor.sink.VarDeclStmt:7.7)
// 419.2-422.29: (class anchor.sink.Assign:8.25)
// 423.2-428.9: (class anchor.sink.Return:4.21)
// 503.1-503.34: (3.5): Node.x failed Write-Write Right-Mover Check
// 560.1-560.30: (3.5): Node.x failed Write-Read Right-Mover Check
// 621.1-621.34: (3.5): Node.x failed Write-Write Left-Mover Check
// 679.1-679.30: (3.5): Node.x failed Write-Read Left-Mover Check
// 734.1-734.34: (3.5): Node.x failed Read-Write Right-Mover Check
// 792.1-792.34: (3.5): Node.x failed Read-Write Left-Mover Check
// 861.1-861.140: (3.5): Node.x is not Write-Write Stable with respect to Node.x (case A.1)
// 862.1-862.101: (3.5): Node.x is not Write-Write Stable with respect to Node.x (case A.2)
// 863.1-863.158: (3.5): Node.x is not Write-Write Stable with respect to Node.x (case A.3)
// 956.1-956.140: (3.5): Node.x is not Write-Write Stable with respect to Node.x (case C)
// 1054.1-1054.144: (3.5): Node.x is not Write-Write Stable with respect to Node.x (case D)
// 1055.1-1055.144: (3.5): Node.x is not Write-Write Stable with respect to Node.x (case R)
// 1124.1-1124.136: (3.5): Node.x is not Read-Write Stable with respect to Node.x (case F)
// 1125.1-1125.136: (3.5): Node.x is not Read-Write Stable with respect to Node.x (case H)
// 1126.1-1126.146: (3.5): Node.x is not Read-Write Stable with respect to Node.x (case I)
// 1194.1-1194.136: (3.5): Node.x is not Write-Read Stable with respect to Node.x (case J)
// 1195.1-1195.136: (3.5): Node.x is not Write-Read Stable with respect to Node.x (case K)
// 1196.1-1196.99: (3.5): Node.x is not Write-Read Stable with respect to Node.x (case L)
// 1227.1-1246.2: (3.5): yields_as clause for Node.x is not valid
// 1251.1-1265.2: (3.5): yields_as clause for Node.x is not reflexive
// 1271.1-1299.2: (3.5): yields_as clause for Node.x is not transitive
// 1319.1-1338.2: (7.32): yields_as clause for Node._lock is not valid
// 1343.1-1357.2: (7.32): yields_as clause for Node._lock is not reflexive
// 1363.1-1391.2: (7.32): yields_as clause for Node._lock is not transitive
