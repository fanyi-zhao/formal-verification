 ...
 /home/artifact/Synchronicity/workspace/Synchronicity/tests/immutable-lock.sink:                    
...
function {:inline} Invariant.Cow.2201666(tid: Tid,this : Cow,Cow._state: [Cow]State,Cow.x: [Cow]int,Cow.y: [Cow]Cow,Cow._lock: [Cow]Tid) returns (bool) {
 (Cow.y[this]!=Cow.null)                                                                            
}                                                                                                   
...
requires  (forall _this : Cow ::  { Cow._state[_this] } isAccessible(Cow._state[_this], tid) && true ==> Invariant.Cow.2201666(tid: Tid,_this : Cow,Cow._state,Cow.x,Cow.y,Cow._lock));       // (9.2): Object invariant may not hold.
                                                                                                    
ensures StateInvariant(Cow._state, Cow.x, Cow.y, Cow._lock);                                        
ensures  (forall _this : Cow ::  { Cow._state[_this] } isAccessible(Cow._state[_this], tid) && true ==> Invariant.Cow.2201666(tid: Tid,_this : Cow,Cow._state,Cow.x,Cow.y,Cow._lock));       // (9.2): Object invariant may not hold.
{                                                                                                   
 var Cow._state2201816_post: [Cow]State;                                                            
 var $recorded.state2201816_post: int;                                                              
 var this_y2201832: Cow;                                                                            
 var $pc2201816_post: Phase;                                                                        
 var $recorded.state2201816: int;                                                                   
 var moverPath2201815: MoverPath;                                                                   
 var this_y2201837: Cow;                                                                            
 var xx2201832: int;                                                                                
 var path2201832: int;                                                                              
 var xx2201837: int;                                                                                
 var $pc2201822: Phase;                                                                             
 var path2201822: int;                                                                              
 var Cow.x2201816: [Cow]int;                                                                        
 var y2201815: Cow;                                                                                 
 var Cow._state2201837: [Cow]State;                                                                 
 var Cow._lock2201815: [Cow]Tid;                                                                    
 var mover2201822: Mover;                                                                           
 var this2201816_post: Cow;                                                                         
 var this2201832: Cow;                                                                              
 var Cow.x2201827: [Cow]int;                                                                        
 var moverPath2201832: MoverPath;                                                                   
 var $recorded.state2201815: int;                                                                   
 var Cow._lock2201837: [Cow]Tid;                                                                    
 var Cow.y2201815: [Cow]Cow;                                                                        
 var Cow._lock2201827: [Cow]Tid;                                                                    
 var Cow.y2201827: [Cow]Cow;                                                                        
 var tid2201815: Tid;                                                                               
 var xx2201827: int;                                                                                
 var Cow._state2201827: [Cow]State;                                                                 
 var Cow._state2201832: [Cow]State;                                                                 
 var this2201837: Cow;                                                                              
 var path2201815: int;                                                                              
 var this2201815: Cow;                                                                              
 var this_y2201827: Cow;                                                                            
 var Cow.y2201816: [Cow]Cow;                                                                        
 var $pc2201816: Phase;                                                                             
 var xx2201816_post: int;                                                                           
 var Cow._lock2201832: [Cow]Tid;                                                                    
 var y2201827: Cow;                                                                                 
 var mover2201832: Mover;                                                                           
 var tid2201816: Tid;                                                                               
 var Cow.x2201837: [Cow]int;                                                                        
 var y2201816: Cow;                                                                                 
 var tid2201827: Tid;                                                                               
 var this_y: Cow;                                                                                   
 var this2201816: Cow;                                                                              
 var Cow.x2201822: [Cow]int;                                                                        
 var Cow.y2201822: [Cow]Cow;                                                                        
 var Cow.x2201816_post: [Cow]int;                                                                   
 var $pc2201827: Phase;                                                                             
 var moverPath2201822: MoverPath;                                                                   
 var $pc2201837: Phase;                                                                             
 var $recorded.state2201832: int;                                                                   
 var y2201816_post: Cow;                                                                            
 var Cow._state2201816: [Cow]State;                                                                 
 var Cow._state2201822: [Cow]State;                                                                 
 var $recorded.state2201827: int;                                                                   
 var Cow.y2201837: [Cow]Cow;                                                                        
 var Cow.y2201832: [Cow]Cow;                                                                        
 var $recorded.state2201837: int;                                                                   
 var Cow._lock2201816_post: [Cow]Tid;                                                               
 var y2201832: Cow;                                                                                 
 var xx2201822: int;                                                                                
 var xx: int;                                                                                       
 var Cow.y2201816_post: [Cow]Cow;                                                                   
 var $pc2201815: Phase;                                                                             
 var tid2201816_post: Tid;                                                                          
 var xx2201816: int;                                                                                
 var y2201822: Cow;                                                                                 
 var $pc2201832: Phase;                                                                             
 var tid2201832: Tid;                                                                               
 ...
 var xx2201815: int;                                                                                
 var tid2201822: Tid;                                                                               
 var Cow.x2201815: [Cow]int;                                                                        
 var Cow._lock2201822: [Cow]Tid;                                                                    
 var Cow._state2201815: [Cow]State;                                                                 
 var tid2201837: Tid;                                                                               
 var mover2201815: Mover;                                                                           
 var $recorded.state2201822: int;                                                                   
 var Cow._lock2201816: [Cow]Tid;                                                                    
 var y2201837: Cow;                                                                                 
 var this2201827: Cow;                                                                              
 var this2201822: Cow;                                                                              
 var Cow.x2201832: [Cow]int;                                                                        
 var this_y2201822: Cow;                                                                            
 ...
 moverPath2201815 := ReadEval.Cow.y(tid: Tid,this: Cow,Cow._state,Cow.x,Cow.y,Cow._lock);           
 mover2201815 := m#moverPath(moverPath2201815);                                                     
 path2201815 := p#moverPath(moverPath2201815);                                                      
 assume Cow._state2201815 == Cow._state && Cow.x2201815 == Cow.x && Cow.y2201815 == Cow.y && Cow._lock2201815 == Cow._lock && y2201815 == y && xx2201815 == xx && this2201815 == this && tid2201815 == tid && $pc2201815 == $pc;
 assume $recorded.state2201815 == 1;                                                                
 if ($pc == PreCommit) {                                                                            
 ...
 $pc := transition($pc, mover2201815);                                                              
 assert $pc != PhaseError;                                                                                 // (12.3): Reduction failure
 y := Cow.y[this];                                                                                  
                                                                                                    
 // 13.3: yield;                                                                                    
                                                                                                    
 assume Cow._state2201816 == Cow._state && Cow.x2201816 == Cow.x && Cow.y2201816 == Cow.y && Cow._lock2201816 == Cow._lock && y2201816 == y && xx2201816 == xx && this2201816 == this && tid2201816 == tid;
 assume $recorded.state2201816 == 1;                                                                
 assert  (forall _this : Cow ::  { Cow._state[_this] } isAccessible(Cow._state[_this], tid) && true ==> Invariant.Cow.2201666(tid: Tid,_this : Cow,Cow._state,Cow.x,Cow.y,Cow._lock));       // (13.3): Object invariant may not hold.
 call Yield(tid);                                                                                   
 assume  (forall _this : Cow ::  { Cow._state[_this] } isAccessible(Cow._state[_this], tid) && true ==> Invariant.Cow.2201666(tid: Tid,_this : Cow,Cow._state,Cow.x,Cow.y,Cow._lock));       // (13.3): Object invariant may not hold.
 $pc := PreCommit;                                                                                  
 assume Cow._state2201816_post == Cow._state && Cow.x2201816_post == Cow.x && Cow.y2201816_post == Cow.y && Cow._lock2201816_post == Cow._lock && y2201816_post == y && xx2201816_post == xx && this2201816_post == this && tid2201816_post == tid;
 assume $recorded.state2201816_post == 1;                                                           
 ...
 moverPath2201822 := ReadEval.Cow.y(tid: Tid,this: Cow,Cow._state,Cow.x,Cow.y,Cow._lock);           
 mover2201822 := m#moverPath(moverPath2201822);                                                     
 path2201822 := p#moverPath(moverPath2201822);                                                      
 assume Cow._state2201822 == Cow._state && Cow.x2201822 == Cow.x && Cow.y2201822 == Cow.y && Cow._lock2201822 == Cow._lock && this_y2201822 == this_y && y2201822 == y && xx2201822 == xx && this2201822 == this && tid2201822 == tid && $pc2201822 == $pc;
 assume $recorded.state2201822 == 1;                                                                
 if ($pc == PreCommit) {                                                                            
  assume this != Cow.null;                                                                          
 } else {                                                                                           
 ...
 $pc := transition($pc, mover2201822);                                                              
 assert $pc != PhaseError;                                                                                 // (14.3): Reduction failure
 this_y := Cow.y[this];                                                                             
                                                                                                    
 // 15.3: assert y == this_y;                                                                       
                                                                                                    
 assume Cow._state2201827 == Cow._state && Cow.x2201827 == Cow.x && Cow.y2201827 == Cow.y && Cow._lock2201827 == Cow._lock && this_y2201827 == this_y && y2201827 == y && xx2201827 == xx && this2201827 == this && tid2201827 == tid;
 assume $recorded.state2201827 == 1;                                                                
 assert (y==this_y);                                                                                       // (15.3): This assertion may not hold.
 if ($pc == PreCommit) {                                                                            
  assume y != Cow.null;                                                                             
 } else {                                                                                           
  assert y != Cow.null;                                                                                    // (16.16): Cannot have potential null deference in left-mover part.
 }                                                                                                  
 assume Cow._lock[y] == Tid.null;                                                                   
 $pc := transition($pc, _R);                                                                        
 assert $pc != PhaseError;                                                                                 // (16.16): Reduction failure
 Cow._lock[y] := tid;                                                                               
 ...
 moverPath2201832 := WriteEval.Cow.x(tid: Tid,this: Cow,xx: int,Cow._state,Cow.x,Cow.y,Cow._lock);  
 mover2201832 := m#moverPath(moverPath2201832);                                                     
 path2201832 := p#moverPath(moverPath2201832);                                                      
 assume Cow._state2201832 == Cow._state && Cow.x2201832 == Cow.x && Cow.y2201832 == Cow.y && Cow._lock2201832 == Cow._lock && this_y2201832 == this_y && y2201832 == y && xx2201832 == xx && this2201832 == this && tid2201832 == tid && $pc2201832 == $pc;
 assume $recorded.state2201832 == 1;                                                                
 if ($pc == PreCommit) {                                                                            
  assume this != Cow.null;                                                                          
 } else {                                                                                           
  assert this != Cow.null;                                                                                 // (17.4): Cannot have potential null deference in left-mover part.
 }                                                                                                  
 $pc := transition($pc, mover2201832);                                                              
 assert $pc != PhaseError;                                                                                 // (17.4): Reduction failure
 Cow.x[this] := xx;                                                                                 
 if ($pc == PreCommit) {                                                                            
  assume y != Cow.null;                                                                             
 } else {                                                                                           
  assert y != Cow.null;                                                                                    // (18.3): Cannot have potential null deference in left-mover part.
 }                                                                                                  
 assert Cow._lock[y] == tid;                                                                               // (18.3): lock not held
 $pc := transition($pc, _L);                                                                        
 ...
 assume Cow._state2201837 == Cow._state && Cow.x2201837 == Cow.x && Cow.y2201837 == Cow.y && Cow._lock2201837 == Cow._lock && this_y2201837 == this_y && y2201837 == y && xx2201837 == xx && this2201837 == this && tid2201837 == tid;
 assume $recorded.state2201837 == 1;                                                                
 assert  (forall _this : Cow ::  { Cow._state[_this] } isAccessible(Cow._state[_this], tid) && true ==> Invariant.Cow.2201666(tid: Tid,_this : Cow,Cow._state,Cow.x,Cow.y,Cow._lock));       // (9.18): Object invariant may not hold.
 return;                                                                                            
}                                                                                                   
...
requires  (forall _this : Cow ::  { Cow._state[_this] } isAccessible(Cow._state[_this], tid) && true ==> Invariant.Cow.2201666(tid: Tid,_this : Cow,Cow._state,Cow.x,Cow.y,Cow._lock));       // (<undefined position>): Object invariant may not hold.
modifies Cow._state;                                                                                
modifies Cow.x;                                                                                     
modifies Cow.y;                                                                                     
modifies Cow._lock;                                                                                 
...
ensures  (forall _this : Cow ::  { Cow._state[_this] } isAccessible(Cow._state[_this], tid) && true ==> Invariant.Cow.2201666(tid: Tid,_this : Cow,Cow._state,Cow.x,Cow.y,Cow._lock));       // (<undefined position>): Object invariant may not hold.
...
procedure Y_Cow.x.Transitive(tid : Tid, this: Cow, newValue : int , Cow._state: [Cow]State, Cow.x: [Cow]int, Cow.y: [Cow]Cow, Cow._lock: [Cow]Tid , Cow._state_p: [Cow]State, Cow.x_p: [Cow]int, Cow.y_p: [Cow]Cow, Cow._lock_p: [Cow]Tid)
 ...
 requires ValidTid(tid);                                                                            
requires  (forall _this : Cow ::  { Cow._state[_this] } isAccessible(Cow._state[_this], tid) && true ==> Invariant.Cow.2201666(tid: Tid,_this : Cow,Cow._state,Cow.x,Cow.y,Cow._lock));       // (4.9): Object invariant may not hold.
...
procedure Y_Cow.y.Transitive(tid : Tid, this: Cow, newValue : Cow , Cow._state: [Cow]State, Cow.x: [Cow]int, Cow.y: [Cow]Cow, Cow._lock: [Cow]Tid , Cow._state_p: [Cow]State, Cow.x_p: [Cow]int, Cow.y_p: [Cow]Cow, Cow._lock_p: [Cow]Tid)
 ...
 requires StateInvariant(Cow._state_p, Cow.x_p, Cow.y_p, Cow._lock_p);                              
 requires ValidTid(tid);                                                                            
requires  (forall _this : Cow ::  { Cow._state[_this] } isAccessible(Cow._state[_this], tid) && true ==> Invariant.Cow.2201666(tid: Tid,_this : Cow,Cow._state,Cow.x,Cow.y,Cow._lock));       // (5.10): Object invariant may not hold.
...
procedure Y_Cow._lock.Transitive(tid : Tid, this: Cow, newValue : Tid , Cow._state: [Cow]State, Cow.x: [Cow]int, Cow.y: [Cow]Cow, Cow._lock: [Cow]Tid , Cow._state_p: [Cow]State, Cow.x_p: [Cow]int, Cow.y_p: [Cow]Cow, Cow._lock_p: [Cow]Tid)
 ...
 requires StateInvariant(Cow._state_p, Cow.x_p, Cow.y_p, Cow._lock_p);                              
 requires ValidTid(tid);                                                                            
requires  (forall _this : Cow ::  { Cow._state[_this] } isAccessible(Cow._state[_this], tid) && true ==> Invariant.Cow.2201666(tid: Tid,_this : Cow,Cow._state,Cow.x,Cow.y,Cow._lock));       // (3.1): Object invariant may not hold.
...
// 470.1-691.2: (Method:9.2)
// 478.1-478.24: (9.2): Bad tid
// 479.1-479.37: (9.2): this is not global
// 482.1-482.184: (9.2): Object invariant may not hold.
// 485.1-485.183: (9.2): Object invariant may not hold.
// 578.2-581.33: (class anchor.sink.Assume:10.4)
// 582.2-584.2: (class anchor.sink.VarDeclStmt:11.3)
// 585.2-588.10: (class anchor.sink.Assign:11.12)
// 589.2-591.2: (class anchor.sink.VarDeclStmt:12.3)
// 592.2-609.19: (class anchor.sink.Read:12.3)
// 604.1-604.27: (12.3): Cannot have potential null deference in left-mover part.
// 608.1-608.27: (12.3): Reduction failure
// 610.2-620.42: (class anchor.sink.Yield:13.3)
// 615.1-615.183: (13.3): Object invariant may not hold.
// 617.1-617.183: (13.3): Object invariant may not hold.
// 621.2-623.2: (class anchor.sink.VarDeclStmt:14.3)
// 624.2-641.24: (class anchor.sink.Read:14.3)
// 636.1-636.27: (14.3): Cannot have potential null deference in left-mover part.
// 640.1-640.27: (14.3): Reduction failure
// 642.2-647.21: (class anchor.sink.Assert:15.3)
// 647.1-647.21: (15.3): This assertion may not hold.
// 651.1-651.24: (16.16): Cannot have potential null deference in left-mover part.
// 655.1-655.27: (16.16): Reduction failure
// 658.2-674.20: (class anchor.sink.Write:17.4)
// 670.1-670.27: (17.4): Cannot have potential null deference in left-mover part.
// 673.1-673.27: (17.4): Reduction failure
// 678.1-678.24: (18.3): Cannot have potential null deference in left-mover part.
// 680.1-680.29: (18.3): lock not held
// 682.1-682.27: (18.3): Reduction failure
// 684.2-690.9: (class anchor.sink.Return:9.18)
// 689.1-689.183: (9.18): Object invariant may not hold.
// 769.1-769.34: (4.2): Cow.x failed Write-Write Right-Mover Check
// 828.1-828.30: (4.2): Cow.x failed Write-Read Right-Mover Check
// 891.1-891.34: (4.2): Cow.x failed Write-Write Left-Mover Check
// 951.1-951.30: (4.2): Cow.x failed Write-Read Left-Mover Check
// 1008.1-1008.34: (4.2): Cow.x failed Read-Write Right-Mover Check
// 1068.1-1068.34: (4.2): Cow.x failed Read-Write Left-Mover Check
// 1127.1-1127.34: (5.2): Cow.y failed Write-Write Right-Mover Check
// 1186.1-1186.30: (5.2): Cow.y failed Write-Read Right-Mover Check
// 1249.1-1249.34: (5.2): Cow.y failed Write-Write Left-Mover Check
// 1309.1-1309.30: (5.2): Cow.y failed Write-Read Left-Mover Check
// 1366.1-1366.34: (5.2): Cow.y failed Read-Write Right-Mover Check
// 1426.1-1426.34: (5.2): Cow.y failed Read-Write Left-Mover Check
// 1497.1-1497.140: (4.2): Cow.x is not Write-Write Stable with respect to Cow.x (case A.1)
// 1498.1-1498.101: (4.2): Cow.x is not Write-Write Stable with respect to Cow.x (case A.2)
// 1499.1-1499.158: (4.2): Cow.x is not Write-Write Stable with respect to Cow.x (case A.3)
// 1595.1-1595.140: (4.2): Cow.x is not Write-Write Stable with respect to Cow.x (case C)
// 1696.1-1696.144: (4.2): Cow.x is not Write-Write Stable with respect to Cow.x (case D)
// 1697.1-1697.144: (4.2): Cow.x is not Write-Write Stable with respect to Cow.x (case R)
// 1768.1-1768.136: (4.2): Cow.x is not Read-Write Stable with respect to Cow.x (case F)
// 1769.1-1769.136: (4.2): Cow.x is not Read-Write Stable with respect to Cow.x (case H)
// 1770.1-1770.146: (4.2): Cow.x is not Read-Write Stable with respect to Cow.x (case I)
// 1840.1-1840.136: (4.2): Cow.x is not Write-Read Stable with respect to Cow.x (case J)
// 1841.1-1841.136: (4.2): Cow.x is not Write-Read Stable with respect to Cow.x (case K)
// 1842.1-1842.99: (4.2): Cow.x is not Write-Read Stable with respect to Cow.x (case L)
// 1914.1-1914.140: (5.2): Cow.y is not Write-Write Stable with respect to Cow.x (case A.1)
// 1915.1-1915.101: (5.2): Cow.y is not Write-Write Stable with respect to Cow.x (case A.2)
// 1916.1-1916.158: (5.2): Cow.y is not Write-Write Stable with respect to Cow.x (case A.3)
// 2012.1-2012.140: (4.2): Cow.x is not Write-Write Stable with respect to Cow.y (case C)
// 2113.1-2113.144: (4.2): Cow.x is not Write-Write Stable with respect to Cow.y (case D)
// 2114.1-2114.144: (4.2): Cow.x is not Write-Write Stable with respect to Cow.y (case R)
// 2185.1-2185.136: (4.2): Cow.x is not Read-Write Stable with respect to Cow.y (case F)
// 2186.1-2186.136: (4.2): Cow.x is not Read-Write Stable with respect to Cow.y (case H)
// 2187.1-2187.146: (4.2): Cow.x is not Read-Write Stable with respect to Cow.y (case I)
// 2257.1-2257.136: (5.2): Cow.y is not Write-Read Stable with respect to Cow.x (case J)
// 2258.1-2258.136: (5.2): Cow.y is not Write-Read Stable with respect to Cow.x (case K)
// 2259.1-2259.99: (5.2): Cow.y is not Write-Read Stable with respect to Cow.x (case L)
// 2331.1-2331.140: (4.2): Cow.x is not Write-Write Stable with respect to Cow.y (case A.1)
// 2332.1-2332.101: (4.2): Cow.x is not Write-Write Stable with respect to Cow.y (case A.2)
// 2333.1-2333.158: (4.2): Cow.x is not Write-Write Stable with respect to Cow.y (case A.3)
// 2429.1-2429.140: (5.2): Cow.y is not Write-Write Stable with respect to Cow.x (case C)
// 2530.1-2530.144: (5.2): Cow.y is not Write-Write Stable with respect to Cow.x (case D)
// 2531.1-2531.144: (5.2): Cow.y is not Write-Write Stable with respect to Cow.x (case R)
// 2602.1-2602.136: (5.2): Cow.y is not Read-Write Stable with respect to Cow.x (case F)
// 2603.1-2603.136: (5.2): Cow.y is not Read-Write Stable with respect to Cow.x (case H)
// 2604.1-2604.146: (5.2): Cow.y is not Read-Write Stable with respect to Cow.x (case I)
// 2674.1-2674.136: (4.2): Cow.x is not Write-Read Stable with respect to Cow.y (case J)
// 2675.1-2675.136: (4.2): Cow.x is not Write-Read Stable with respect to Cow.y (case K)
// 2676.1-2676.99: (4.2): Cow.x is not Write-Read Stable with respect to Cow.y (case L)
// 2748.1-2748.140: (5.2): Cow.y is not Write-Write Stable with respect to Cow.y (case A.1)
// 2749.1-2749.101: (5.2): Cow.y is not Write-Write Stable with respect to Cow.y (case A.2)
// 2750.1-2750.158: (5.2): Cow.y is not Write-Write Stable with respect to Cow.y (case A.3)
// 2846.1-2846.140: (5.2): Cow.y is not Write-Write Stable with respect to Cow.y (case C)
// 2947.1-2947.144: (5.2): Cow.y is not Write-Write Stable with respect to Cow.y (case D)
// 2948.1-2948.144: (5.2): Cow.y is not Write-Write Stable with respect to Cow.y (case R)
// 3019.1-3019.136: (5.2): Cow.y is not Read-Write Stable with respect to Cow.y (case F)
// 3020.1-3020.136: (5.2): Cow.y is not Read-Write Stable with respect to Cow.y (case H)
// 3021.1-3021.146: (5.2): Cow.y is not Read-Write Stable with respect to Cow.y (case I)
// 3091.1-3091.136: (5.2): Cow.y is not Write-Read Stable with respect to Cow.y (case J)
// 3092.1-3092.136: (5.2): Cow.y is not Write-Read Stable with respect to Cow.y (case K)
// 3093.1-3093.99: (5.2): Cow.y is not Write-Read Stable with respect to Cow.y (case L)
// 3100.1-3100.184: (<undefined position>): Object invariant may not hold.
// 3107.1-3107.183: (<undefined position>): Object invariant may not hold.
// 3127.1-3147.2: (4.2): yields_as clause for Cow.x is not valid
// 3152.1-3167.2: (4.2): yields_as clause for Cow.x is not reflexive
// 3173.1-3173.184: (4.9): Object invariant may not hold.
// 3174.1-3204.2: (4.2): yields_as clause for Cow.x is not transitive
// 3223.1-3243.2: (5.2): yields_as clause for Cow.y is not valid
// 3248.1-3263.2: (5.2): yields_as clause for Cow.y is not reflexive
// 3269.1-3269.184: (5.10): Object invariant may not hold.
// 3270.1-3300.2: (5.2): yields_as clause for Cow.y is not transitive
// 3320.1-3340.2: (7.32): yields_as clause for Cow._lock is not valid
// 3345.1-3360.2: (7.32): yields_as clause for Cow._lock is not reflexive
// 3366.1-3366.184: (3.1): Object invariant may not hold.
// 3367.1-3397.2: (7.32): yields_as clause for Cow._lock is not transitive
