 ...
 /home/fzhao12/Synchronicity/workspace/Synchronicity/tests/assert.sink:                             
...
requires ValidTid(tid);                                                                                    // (3.2): Bad tid
requires isShared(Cow._state[this]);                                                                       // (3.2): this is not global
                                                                                                    
requires StateInvariant(Cow._state, Cow._lock);                                                     
                                                                                                    
ensures StateInvariant(Cow._state, Cow._lock);                                                      
{                                                                                                   
 var Cow._lock157581: [Cow]Tid;                                                                     
 var this157581: Cow;                                                                               
 var Cow._lock157582: [Cow]Tid;                                                                     
 var $pc157581: Phase;                                                                              
 var $recorded.state157581: int;                                                                    
 var $recorded.state157582: int;                                                                    
 var $pc157582: Phase;                                                                              
 var tid157582: Tid;                                                                                
 var tid157581: Tid;                                                                                
 var Cow._state157582: [Cow]State;                                                                  
 var this157582: Cow;                                                                               
 var Cow._state157581: [Cow]State;                                                                  
 ...
 assume Cow._state157581 == Cow._state && Cow._lock157581 == Cow._lock && this157581 == this && tid157581 == tid;
 assume $recorded.state157581 == 1;                                                                 
 assert false;                                                                                             // (4.3): This assertion may not hold.
                                                                                                    
 // 3.18: // return;                                                                                
                                                                                                    
 assume Cow._state157582 == Cow._state && Cow._lock157582 == Cow._lock && this157582 == this && tid157582 == tid;
 assume $recorded.state157582 == 1;                                                                 
 return;                                                                                            
}                                                                                                   
...
// 338.1-380.2: (Method:3.2)
// 344.1-344.24: (3.2): Bad tid
// 345.1-345.37: (3.2): this is not global
// 368.2-373.15: (class anchor.sink.Assert:4.3)
// 373.1-373.15: (4.3): This assertion may not hold.
// 374.2-379.9: (class anchor.sink.Return:3.18)
// 427.1-445.2: (7.32): yields_as clause for Cow._lock is not valid
// 450.1-463.2: (7.32): yields_as clause for Cow._lock is not reflexive
// 469.1-495.2: (7.32): yields_as clause for Cow._lock is not transitive
