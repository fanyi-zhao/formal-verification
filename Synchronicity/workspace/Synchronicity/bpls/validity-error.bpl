 ...
 /home/artifact/Synchronicity/workspace/Synchronicity/tests/validity-error.anchor:                  
...
//// Spec Checks                                                                                    
 ...
 assert isError(_writeByU_Mover);                                                                          // (5.5): BadDiscipline.value failed Write-Write Right-Mover Check
 }                                                                                                  
 ...
 assert _readByU_Mover == _E;                                                                              // (5.5): BadDiscipline.value failed Write-Read Right-Mover Check
 }                                                                                                  
 ...
 _writeByU_Mover := m#moverPath(_writeByU);                                                         
 _writeByU_Path := p#moverPath(_writeByU);                                                          
 assert isError(_writeByU_Mover);                                                                          // (5.5): BadDiscipline.value failed Write-Write Left-Mover Check
 }                                                                                                  
 ...
 assert _readByU_Mover == _E;                                                                              // (5.5): BadDiscipline.value failed Write-Read Left-Mover Check
 }                                                                                                  
 ...
 assert isError(_writeByU_Mover);                                                                          // (5.5): BadDiscipline.value failed Read-Write Right-Mover Check
 }                                                                                                  
 ...
 assert isError(_writeByU_Mover);                                                                          // (5.5): BadDiscipline.value failed Read-Write Left-Mover Check
 }                                                                                                  
 ...
 assert (leq(_writeByT_Mover, _R) && leq(_writeByUPost_Mover, _E)) ==> ((_writeByU_Mover == _writeByUPost_Mover || _writeByU_Mover == _E));       // (5.5): BadDiscipline.value is not Write-Write Stable with respect to BadDiscipline.value (case A.1)
 assert (leq(_writeByT_Mover, _N) && !leq(_writeByUPost_Mover, _L)) ==> (!leq(_writeByU_Mover, _L));       // (5.5): BadDiscipline.value is not Write-Write Stable with respect to BadDiscipline.value (case A.2)
 assert (x != y && leq(_writeByT_Mover, _N) && leq(_writeByUPost_Mover, _L)) ==> ((_writeByUPost_Mover == _writeByUPost_Mover || _writeByUPost_Mover == _E));       // (5.5): BadDiscipline.value is not Write-Write Stable with respect to BadDiscipline.value (case A.3)
 ...
 assert (leq(_writeByT_Mover, _E) && leq(_writeByU_Mover, _L)) ==> ((_writeByTPost_Mover == _writeByT_Mover || _writeByTPost_Mover == _E));       // (5.5): BadDiscipline.value is not Write-Write Stable with respect to BadDiscipline.value (case C)
 ...
 assert (leq(_writeByT_Mover, _R) && leq(_writeByUPost_Mover, _N)) ==> ((_writeByTPost_Mover == _writeByT_Mover || _writeByTPost_Mover == _E));       // (5.5): BadDiscipline.value is not Write-Write Stable with respect to BadDiscipline.value (case D)
 assert (leq(_writeByT_Mover, _N) && leq(_writeByUPost_Mover, _L)) ==> ((_writeByTPost_Mover == _writeByT_Mover || _writeByTPost_Mover == _E));       // (5.5): BadDiscipline.value is not Write-Write Stable with respect to BadDiscipline.value (case R)
 ...
 assert (leq(_readByT_Mover, _R) && leq(_writeByU_Mover, _N)) ==> ((_readByTPost_Mover == _readByT_Mover || _readByTPost_Mover == _E));       // (5.5): BadDiscipline.value is not Read-Write Stable with respect to BadDiscipline.value (case F)
 assert (leq(_readByT_Mover, _E) && leq(_writeByU_Mover, _L)) ==> ((_readByTPost_Mover == _readByT_Mover || _readByTPost_Mover == _E));       // (5.5): BadDiscipline.value is not Read-Write Stable with respect to BadDiscipline.value (case H)
 assert (x != y && leq(_readByT_Mover, _N) && leq(_writeByU_Mover, _N)) ==> ((_readByTPost_Mover == _readByT_Mover || _readByTPost_Mover == _E));       // (5.5): BadDiscipline.value is not Read-Write Stable with respect to BadDiscipline.value (case I)
 ...
 assert (leq(_writeByT_Mover, _R) && leq(_readByUPost_Mover, _E)) ==> ((_readByU_Mover == _readByUPost_Mover || _readByU_Mover == _E));       // (5.5): BadDiscipline.value is not Write-Read Stable with respect to BadDiscipline.value (case J)
 assert (leq(_writeByT_Mover, _N) && leq(_readByUPost_Mover, _L)) ==> ((_readByU_Mover == _readByUPost_Mover || _readByU_Mover == _E));       // (5.5): BadDiscipline.value is not Write-Read Stable with respect to BadDiscipline.value (case K)
 assert (leq(_writeByT_Mover, _N) && !leq(_readByUPost_Mover, _L)) ==> (!leq(_readByU_Mover, _L));         // (5.5): BadDiscipline.value is not Write-Read Stable with respect to BadDiscipline.value (case L)
...
// 445.1-445.34: (5.5): BadDiscipline.value failed Write-Write Right-Mover Check
// 502.1-502.30: (5.5): BadDiscipline.value failed Write-Read Right-Mover Check
// 563.1-563.34: (5.5): BadDiscipline.value failed Write-Write Left-Mover Check
// 621.1-621.30: (5.5): BadDiscipline.value failed Write-Read Left-Mover Check
// 676.1-676.34: (5.5): BadDiscipline.value failed Read-Write Right-Mover Check
// 734.1-734.34: (5.5): BadDiscipline.value failed Read-Write Left-Mover Check
// 803.1-803.140: (5.5): BadDiscipline.value is not Write-Write Stable with respect to BadDiscipline.value (case A.1)
// 804.1-804.101: (5.5): BadDiscipline.value is not Write-Write Stable with respect to BadDiscipline.value (case A.2)
// 805.1-805.158: (5.5): BadDiscipline.value is not Write-Write Stable with respect to BadDiscipline.value (case A.3)
// 898.1-898.140: (5.5): BadDiscipline.value is not Write-Write Stable with respect to BadDiscipline.value (case C)
// 996.1-996.144: (5.5): BadDiscipline.value is not Write-Write Stable with respect to BadDiscipline.value (case D)
// 997.1-997.144: (5.5): BadDiscipline.value is not Write-Write Stable with respect to BadDiscipline.value (case R)
// 1066.1-1066.136: (5.5): BadDiscipline.value is not Read-Write Stable with respect to BadDiscipline.value (case F)
// 1067.1-1067.136: (5.5): BadDiscipline.value is not Read-Write Stable with respect to BadDiscipline.value (case H)
// 1068.1-1068.146: (5.5): BadDiscipline.value is not Read-Write Stable with respect to BadDiscipline.value (case I)
// 1136.1-1136.136: (5.5): BadDiscipline.value is not Write-Read Stable with respect to BadDiscipline.value (case J)
// 1137.1-1137.136: (5.5): BadDiscipline.value is not Write-Read Stable with respect to BadDiscipline.value (case K)
// 1138.1-1138.99: (5.5): BadDiscipline.value is not Write-Read Stable with respect to BadDiscipline.value (case L)
// 1169.1-1188.2: (5.5): yields_as clause for BadDiscipline.value is not valid
// 1193.1-1207.2: (5.5): yields_as clause for BadDiscipline.value is not reflexive
// 1213.1-1241.2: (5.5): yields_as clause for BadDiscipline.value is not transitive
// 1261.1-1280.2: (7.32): yields_as clause for BadDiscipline._lock is not valid
// 1285.1-1299.2: (7.32): yields_as clause for BadDiscipline._lock is not reflexive
// 1305.1-1333.2: (7.32): yields_as clause for BadDiscipline._lock is not transitive
