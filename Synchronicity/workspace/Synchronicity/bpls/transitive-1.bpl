 ...
 /home/artifact/Synchronicity/workspace/Synchronicity/tests/transitive-1.sink:                      
...
//// Spec Checks                                                                                    
 ...
 assert isError(_writeByU_Mover);                                                                          // (5.2): Cow.x failed Write-Write Right-Mover Check
 }                                                                                                  
 ...
 assert _readByU_Mover == _E;                                                                              // (5.2): Cow.x failed Write-Read Right-Mover Check
 }                                                                                                  
 ...
 _writeByU_Mover := m#moverPath(_writeByU);                                                         
 _writeByU_Path := p#moverPath(_writeByU);                                                          
 assert isError(_writeByU_Mover);                                                                          // (5.2): Cow.x failed Write-Write Left-Mover Check
 }                                                                                                  
 ...
 assert _readByU_Mover == _E;                                                                              // (5.2): Cow.x failed Write-Read Left-Mover Check
 }                                                                                                  
 ...
 assert isError(_writeByU_Mover);                                                                          // (5.2): Cow.x failed Read-Write Right-Mover Check
 }                                                                                                  
 ...
 assert isError(_writeByU_Mover);                                                                          // (5.2): Cow.x failed Read-Write Left-Mover Check
 }                                                                                                  
 ...
 assert (leq(_writeByT_Mover, _R) && leq(_writeByUPost_Mover, _E)) ==> ((_writeByU_Mover == _writeByUPost_Mover || _writeByU_Mover == _E));       // (5.2): Cow.x is not Write-Write Stable with respect to Cow.x (case A.1)
 assert (leq(_writeByT_Mover, _N) && !leq(_writeByUPost_Mover, _L)) ==> (!leq(_writeByU_Mover, _L));       // (5.2): Cow.x is not Write-Write Stable with respect to Cow.x (case A.2)
 assert (x != y && leq(_writeByT_Mover, _N) && leq(_writeByUPost_Mover, _L)) ==> ((_writeByUPost_Mover == _writeByUPost_Mover || _writeByUPost_Mover == _E));       // (5.2): Cow.x is not Write-Write Stable with respect to Cow.x (case A.3)
 ...
 assert (leq(_writeByT_Mover, _E) && leq(_writeByU_Mover, _L)) ==> ((_writeByTPost_Mover == _writeByT_Mover || _writeByTPost_Mover == _E));       // (5.2): Cow.x is not Write-Write Stable with respect to Cow.x (case C)
 ...
 assert (leq(_writeByT_Mover, _R) && leq(_writeByUPost_Mover, _N)) ==> ((_writeByTPost_Mover == _writeByT_Mover || _writeByTPost_Mover == _E));       // (5.2): Cow.x is not Write-Write Stable with respect to Cow.x (case D)
 assert (leq(_writeByT_Mover, _N) && leq(_writeByUPost_Mover, _L)) ==> ((_writeByTPost_Mover == _writeByT_Mover || _writeByTPost_Mover == _E));       // (5.2): Cow.x is not Write-Write Stable with respect to Cow.x (case R)
 ...
 assert (leq(_readByT_Mover, _R) && leq(_writeByU_Mover, _N)) ==> ((_readByTPost_Mover == _readByT_Mover || _readByTPost_Mover == _E));       // (5.2): Cow.x is not Read-Write Stable with respect to Cow.x (case F)
 assert (leq(_readByT_Mover, _E) && leq(_writeByU_Mover, _L)) ==> ((_readByTPost_Mover == _readByT_Mover || _readByTPost_Mover == _E));       // (5.2): Cow.x is not Read-Write Stable with respect to Cow.x (case H)
 assert (x != y && leq(_readByT_Mover, _N) && leq(_writeByU_Mover, _N)) ==> ((_readByTPost_Mover == _readByT_Mover || _readByTPost_Mover == _E));       // (5.2): Cow.x is not Read-Write Stable with respect to Cow.x (case I)
 ...
 assert (leq(_writeByT_Mover, _R) && leq(_readByUPost_Mover, _E)) ==> ((_readByU_Mover == _readByUPost_Mover || _readByU_Mover == _E));       // (5.2): Cow.x is not Write-Read Stable with respect to Cow.x (case J)
 assert (leq(_writeByT_Mover, _N) && leq(_readByUPost_Mover, _L)) ==> ((_readByU_Mover == _readByUPost_Mover || _readByU_Mover == _E));       // (5.2): Cow.x is not Write-Read Stable with respect to Cow.x (case K)
 assert (leq(_writeByT_Mover, _N) && !leq(_readByUPost_Mover, _L)) ==> (!leq(_readByU_Mover, _L));         // (5.2): Cow.x is not Write-Read Stable with respect to Cow.x (case L)
...
// 393.1-393.34: (5.2): Cow.x failed Write-Write Right-Mover Check
// 450.1-450.30: (5.2): Cow.x failed Write-Read Right-Mover Check
// 511.1-511.34: (5.2): Cow.x failed Write-Write Left-Mover Check
// 569.1-569.30: (5.2): Cow.x failed Write-Read Left-Mover Check
// 624.1-624.34: (5.2): Cow.x failed Read-Write Right-Mover Check
// 682.1-682.34: (5.2): Cow.x failed Read-Write Left-Mover Check
// 751.1-751.140: (5.2): Cow.x is not Write-Write Stable with respect to Cow.x (case A.1)
// 752.1-752.101: (5.2): Cow.x is not Write-Write Stable with respect to Cow.x (case A.2)
// 753.1-753.158: (5.2): Cow.x is not Write-Write Stable with respect to Cow.x (case A.3)
// 846.1-846.140: (5.2): Cow.x is not Write-Write Stable with respect to Cow.x (case C)
// 944.1-944.144: (5.2): Cow.x is not Write-Write Stable with respect to Cow.x (case D)
// 945.1-945.144: (5.2): Cow.x is not Write-Write Stable with respect to Cow.x (case R)
// 1014.1-1014.136: (5.2): Cow.x is not Read-Write Stable with respect to Cow.x (case F)
// 1015.1-1015.136: (5.2): Cow.x is not Read-Write Stable with respect to Cow.x (case H)
// 1016.1-1016.146: (5.2): Cow.x is not Read-Write Stable with respect to Cow.x (case I)
// 1084.1-1084.136: (5.2): Cow.x is not Write-Read Stable with respect to Cow.x (case J)
// 1085.1-1085.136: (5.2): Cow.x is not Write-Read Stable with respect to Cow.x (case K)
// 1086.1-1086.99: (5.2): Cow.x is not Write-Read Stable with respect to Cow.x (case L)
// 1117.1-1136.2: (5.2): yields_as clause for Cow.x is not valid
// 1141.1-1155.2: (5.2): yields_as clause for Cow.x is not reflexive
// 1161.1-1189.2: (5.2): yields_as clause for Cow.x is not transitive
// 1209.1-1228.2: (7.32): yields_as clause for Cow._lock is not valid
// 1233.1-1247.2: (7.32): yields_as clause for Cow._lock is not reflexive
// 1253.1-1281.2: (7.32): yields_as clause for Cow._lock is not transitive
